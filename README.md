This repository comprises a Python script (finance_data_extraction.py) for extracting finance data, along with instructions for setting up an Azure environment, 
